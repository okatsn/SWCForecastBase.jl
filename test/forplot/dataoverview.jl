...
@testset "dataoverview.jl" begin
    ...
    args1 = SWCForecastBase.dataoverview(table_nan, DateTime)
    args2 = DataRatio(table_nan, Month(1), SWCForecastBase.islnan) |> SWCForecastBase.convert_arguments

    @test isequal(args1[1:3], args2)
end
